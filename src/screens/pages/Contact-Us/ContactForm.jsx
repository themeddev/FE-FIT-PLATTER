...
const ContactForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const formEndpoint = 'https://formspree.io/your-email@example.com';
    try {
            ...
            <div className="grid md:grid-cols-2">
              <div className="h-full pr-6">
                ...
                <ul class="mb-6 md:mb-0">
                    <li class="flex">
                        <div class="flex h-10 w-10 items-center justify-center rounded bg-myOrange text-gray-50">
                        ...
                        <div class="ml-4 mb-4">
                            <h3 class="mb-2 text-lg font-medium leading-6 text-headersBlue ">Our Address
                            </h3>
                            <p class="text-gray-600 ">Assalam Agadir 80000</p>
                    ...
                    <li class="flex">
                        ...
                        <div class="ml-4 mb-4">
                            <h3 class="mb-2 text-lg font-medium leading-6 text-headersBlue ">Contact
                            </h3>
                            <p class="text-gray-600">Mobile: +212 752-123 934</p>
                            <p class="text-gray-600">Mail: Contact@fitplatter.com</p>
                        </div>
                    </li>
                    <li class="flex">
                        <div class="flex h-10 w-10 items-center justify-center rounded bg-myOrange text-gray-50">
                        ...
                        <div class="ml-4 mb-4">
                            <h3 class="mb-2 text-lg font-medium leading-6 text-headersBlue ">Working
                                hours</h3>
                            <p class="text-gray-600 ">Monday - Friday: 10:00 - 20:00</p>
                            <p class="text-gray-600 ">Saturday &amp; Sunday: 10:00 - 18:00</p>
                        </div>
                    </li>
                </ul>
              </div>
              <div className="card h-fit max-w-6xl p-5 md:p-12" id="form">
                ...
                <form id="contactForm" onSubmit={handleSubmit}>
                  ...
                  <div class="mx-0 mb-1 sm:mb-4">
                    <textarea 
                      onChange={handleChange}
                      id="textarea" name="textarea" cols="30" rows="5" placeholder="Write your message..." class="mb-2 w-full rounded-md bg-white border-2 border-InputBg outline-none focus:border-myOrange  py-2 pl-2 pr-4 shadow-md sm:mb-0">  
                    </textarea>
                  </div>
