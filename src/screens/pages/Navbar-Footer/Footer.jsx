      ...
      <section className="bg-white">
          <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-6 overflow-hidden sm:px-6 lg:px-8">
            ...
            <nav className="flex flex-wrap justify-center -mx-5 -my-2">
                ...
                <div className="px-5 py-2">
                    <Link to='/contact-us  ' className="text-base leading-6 text-gray-500 hover:text-myOrange">
                        Contact
                    </Link>
                </div>
                <div className="px-5 py-2">
                    <Link to="/terms" className="text-base leading-6 text-gray-500 hover:text-myOrange">
                        Terms
                    </Link>
                </div>
            </nav>
            ...
            <div className="flex justify-center mt-8 space-x-6 ">
                <a href="#" className="text-gray-400 hover:text-myOrange">
            ...
            <p className="mt-8 text-base leading-6 text-center text-gray-400">
                © 2024 FIT-PLATTER, Inc. All rights reserved.
            </p>
          </div>
      </section>
    );
